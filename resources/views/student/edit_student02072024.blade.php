                ...
                <div class="col-md-3">
                        ...
                        <table id="coursesOpted" class="table table-bordered table-striped">
                            <thead>
                              ...
                              @php
                                ...
                                $duration = unserialize($student->duration);
                                $i=0;
                              @endphp
                                @foreach(unserialize($student->departments) as $dep)
                              <tr>
                                <td>
                                  <select class="form-control department" name="departments[]" >
                                    <option value="">--Select--</option>
                                    @foreach ($uniqueDepartments as $department)
                                    <option value="{{$department->id}}" @if($department->id == $dep) selected @endif > {{$department->name}} </option>
                                    @endforeach
                                  </select>
                                </td>
                                <td>
                                ...
                                <td><input type="number" value="{{$fees[$i]}}" name="fees[]" class="form-control fees"></td>
                                <td><select name="duration[]" id="" class="form-control duration">
                                  <option value="">--select--</option>
                                  <option value="1" @if($duration[$i] == "1") selected @endif >1 month</option>
                                  <option value="2" @if($duration[$i] == "2") selected @endif>6 month</option>
                                  <option value="3" @if($duration[$i] == "3") selected @endif>12 month</option>
                                </select></td>
                                <td>
                                @if($loop->iteration != 1)
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-3">
                      ...
                      <input type="number" value="{{$student->student_fees->first()->amount}}" name="current_amount" class="form-control">
                        ...
                        <table id="references" class="table table-bordered table-striped">
                            <thead>
                              ...
                              <tr>
                               ...
                               <td>
                                  @if($loop->iteration != 1)
                                  <button type="button" class="btn btn-danger removeRowBtn2">
                                  <i class="fas fa-trash"></i> 
                                  </button>
                                  @endif
                                </td>
